        ...
        <div class="card-body">
          ...
          <form action="<?= base_url('courses/manage/update/' . ($course['id'] ?? '')) ?>" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="course_code" id="course_code" class="form-control" value="<?= old('course_code', $course['course_code'] ?? '') ?>" required placeholder="e.g., CS101, MATH201">
            </div>
            ...
            <div class="mb-3">
              ...
              <select name="year_level" id="year_level" class="form-control">
                ...
                <option value="1st Year" <?= (old('year_level', $course['year_level'] ?? '') === '1st Year') ? 'selected' : '' ?>>1st Year</option>
                <option value="2nd Year" <?= (old('year_level', $course['year_level'] ?? '') === '2nd Year') ? 'selected' : '' ?>>2nd Year</option>
                <option value="3rd Year" <?= (old('year_level', $course['year_level'] ?? '') === '3rd Year') ? 'selected' : '' ?>>3rd Year</option>
                <option value="4th Year" <?= (old('year_level', $course['year_level'] ?? '') === '4th Year') ? 'selected' : '' ?>>4th Year</option>
              </select>
            </div>
            ...
            <?php else: ?>
              <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?= esc($course['instructor_name'] ?? 'Not Assigned') ?>" readonly>
              </div>
            <?php endif; ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="school_year" id="school_year" class="form-control" value="<?= old('school_year', $course['school_year'] ?? '') ?>" placeholder="e.g., 2024-2025">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select name="course_type" id="course_type" class="form-control">
                ...
                <option value="Major" <?= (old('course_type', $course['course_type'] ?? '') === 'Major') ? 'selected' : '' ?>>Major</option>
                <option value="Minor" <?= (old('course_type', $course['course_type'] ?? '') === 'Minor') ? 'selected' : '' ?>>Minor</option>
              </select>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="time" name="start_time" id="start_time" class="form-control" value="<?= old('start_time', $course['start_time'] ?? '') ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="end_time" class="form-label">End Time</label>
                  <input type="time" name="end_time" id="end_time" class="form-control" value="<?= old('end_time', $course['end_time'] ?? '') ?>">
                </div>
              </div>
            </div>
